...
class Recipe:
    """
    A recipe has a list of it's ingredients and how many of each ingredient is
    necessary, as well as how long the recipe would take to produce based on
    the qualifications of the employee. Also the ID of the output item as well
    as how many of that item will be created from this recipe.
    """
